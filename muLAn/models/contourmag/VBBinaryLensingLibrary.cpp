...
// Code adapted for use in muLAn by Arnaud Cassan & Clement Ranc (2017)
...
// ------------------- ADDED BY ARNAUD ----------------------------------
static double magVBB(double s, double q, double rho, double gamma, double y1, double y2, double accuracy)
{
/* Mass ratio of the lens on the right divided by mass of the lens on the left
   Position of the center of the source with respect to the center of mass
   Source coordinates (y1, y2). Source radius Rs < 0.1      */
	VBBinaryLensing VBBL;
	double magnif;
// UNIFORM source
    magnif = VBBL.BinaryMag(s,q,y1,y2,rho,accuracy);
//    printf("  Uniform source magnification = %lf (should be 18.28...)\n",magnif);
    return magnif;
// LLD source : I(r)=I(0)(1-gamma(1-\sqrt{1-r^2/\rho^2}))
//	Mag=VBBL.BinaryMagDark(s,q,y1,y2,Rs,a1,accuracy);
//	printf("  LLD source magnification = %lf (should be 18.27...)\n",Mag);
}
