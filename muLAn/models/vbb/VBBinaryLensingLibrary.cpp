...
// ====================================================================
// Functions added to use with muLAn
// By: the muLAn-poroject team (2017)
// ====================================================================

// Mass ratio of the lens on the right divided by mass of the lens on the left. Position of the center of the source with respect to the center of mass. Source coordinates (y1, y2). Source radius Rs < 0.1

// Uniform source: I(r)=I(0)
static double magVBBU(double s, double q, double rho, double y1, double y2, double accuracy)
{
	VBBinaryLensing VBBL;
	double magnif;
    magnif = VBBL.BinaryMag(s, q, y1, y2, rho, accuracy);
    return magnif;
}

// LLD source: I(r)=I(0)(1-gamma(1-\sqrt{1-r^2/\rho^2}))
    static double magVBBLLD(double s, double q, double rho, double gamma, double y1, double y2, double accuracy)
{
	VBBinaryLensing VBBL;
	double magnif;
	magnif = VBBL.BinaryMagDark(s, q, y1, y2, rho, gamma, accuracy);
    return magnif;
}
