...
if __name__ == '__main__':
    ...
    parser.add_argument('--nchains', nargs=1, type=int, default=[None], help='Replace <NCHAINS> by the number of chains.')
    parser.add_argument('--ncores', nargs=1, type=int, default=[None], help='Replace <NCORES> by the number of cores.')
    ...
    parser.add_argument('-v', '--verbose', nargs=1, type=int, choices=range(0, 6), default=[None], help='Choose a verbose level.')
